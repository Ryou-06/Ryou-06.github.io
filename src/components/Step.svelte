...
cursor-pointer hover:border-green-400 duration-200">
    <div class="bg-slate-950 grid place-item-center px-4 text-5xl md:text-6xl
    ...
    <div class="flex-1 flex justify-between gap-4 items-center">
        ...
        relative after:absolute after:top-0 after:right-full after:w-full after:h-full 
        after:bg-white after:duration-200 hover:after:translate-x-full after:z-[-1] 
        after:rounded-[5px] after:border after:border-slate-300 overflow-hidden">
